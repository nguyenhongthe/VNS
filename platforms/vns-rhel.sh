#!/bin/bash
#================================================================================================================================
# Tên tập lệnh: vns-rhel.sh
# Mô tả: Xây dựng máy chủ chạy web với Python và Next.js thông qua proxy NGINX trên hệ điều hành Red Hat Enterprise Linux (RHEL).
# Đường dẫn: public/vns/platforms/vns-rhel.sh
# Tác giả: Nguyễn Hồng Thế <nguyenhongthe.net>
# Ngày: 2023-08-25
# Phiên bản: 1.0.0
# Giấy phép: Giấy phép MIT
# Sử dụng: curl -sO https://repo.vnscdn.com/vns/platforms/vns-rhel.sh && chmod +x vns-rhel.sh && bash vns-rhel.sh
#================================================================================================================================
...
echo "Phiên bản VNS Script cho RHEL hoặc CentOS: $vns_rhel_version"
...
echo "Hoàn thành cài đặt trên hệ điều hành RHEL hoặc CentOS."
