#!/bin/bash
#=======================================================================================================================
# Tên tập lệnh: vns-ubuntu.sh
# Mô tả: Xây dựng máy chủ chạy web với Python và Next.js thông qua proxy NGINX trên hệ điều hành Ubuntu.
# Đường dẫn: public/vns/platforms/vns-ubuntu.sh
# Tác giả: Nguyễn Hồng Thế <nguyenhongthe.net>
# Ngày: 2023-08-25
# Phiên bản: 1.0.0
# Giấy phép: Giấy phép MIT
# Sử dụng: curl -sO https://repo.vnscdn.com/vns/platforms/vns-ubuntu.sh && chmod +x vns-ubuntu.sh && bash vns-ubuntu.sh
#=======================================================================================================================
...
echo "Hoàn thành cài đặt trên hệ điều hành Ubuntu."
